...
public class MOOverWatchLoadingView: UIView {
    ...
    @IBInspectable var circleColor: UIColor! = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0) {
        didSet {
            outerCircleShape.fillColor = circleColor.cgColor
        }
    }
    
    @IBInspectable var internalColor: UIColor! = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0) {
        didSet {
            self.backgroundColor = internalColor
        }
    }
